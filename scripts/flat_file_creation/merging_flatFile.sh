...
#SBATCH --output=/vast/eande106/projects/Lance/THESIS_WORK/variant_annotation/processed_data/flat_file_creation/c_elegans/SLURM_output/0527_SnpEffFix.oe  
#SBATCH --error=/vast/eande106/projects/Lance/THESIS_WORK/variant_annotation/processed_data/flat_file_creation/c_elegans/SLURM_output/0527_SnpEffFix.rr 
...
if [[ $1 == "c_elegans" ]]; then
    ...
    VEP_flatfile_nHDR="/vast/eande106/projects/Lance/THESIS_WORK/variant_annotation/processed_data/flat_file_creation/c_briggsae/HDRres_merging/VEP_flatFile_c_briggsae.tsv"
    ...
    CSQ_flatfile_nHDR="/vast/eande106/projects/Lance/THESIS_WORK/variant_annotation/processed_data/flat_file_creation/c_briggsae/HDRres_merging/CSQ_flatFile_c_briggsae.tsv"
    ...
    ANNOVAR_flatfile_nHDR="/vast/eande106/projects/Lance/THESIS_WORK/variant_annotation/processed_data/flat_file_creation/c_briggsae/HDRres_merging/ANV_flatFile_c_briggsae.tsv"
...
#################################### FOR BRIGGSAE ##############################################
# sort $ANNOVAR_flatfile_nHDR -t$'\t' -k9,9 > $output_dir/ANNOVAR_tempfinal_sorted.tsv
# sort $VEP_flatfile_nHDR -t$'\t' -k9,9 > $output_dir/VEP_tempfinal_sorted.tsv
# sort $CSQ_flatfile_nHDR -t$'\t' -k9,9 > $output_dir/CSQ_tempfinal_sorted.tsv
# sort $SnpEff_flatfile -t$'\t' -k9,9 > $output_dir/SnpEff_tempfinal_sorted.tsv 
...
# ANNVOAR # 
# join -t$'\t' -1 1 -2 9 -a 2 $output_dir/$(basename $gff)_sorted.tsv $output_dir/ANNOVAR_tempfinal_sorted.tsv | \
#         awk -F'\t' -v OFS='\t' '{
#                 if (NF == 11) {
...
# # VEP #
# join -t$'\t' -1 1 -2 9 -a 2 $output_dir/$(basename $gff)_sorted.tsv $output_dir/VEP_tempfinal_sorted.tsv | \
#         awk -F'\t' -v OFS='\t' '{
#                 if (NF == 11) {
#                         print $4, $5, $6, $7, $8, $9, $10, $11, $1, $2, $3
#                 } else {
...
# CSQ # 
# join -t$'\t' -1 1 -2 9 -a 2 $output_dir/$(basename $gff)_sorted.tsv $output_dir/CSQ_tempfinal_sorted.tsv | \
#         awk -F'\t' -v OFS='\t' '{
#                 if (NF == 11) {
#                         print $4, $5, $6, $7, $8, $9, $10, $11, $1, $2, $3
#                 } else {
...
# sort -k1,1 -k2,2n $output_dir/SnpEff_joined.tsv > $output_dir/SnpEff_${1}_WBGeneID.tsv #### are there "locus" or "gene_names" for MtDNA?
...
#     echo "chrom,pos,ref,alt,consequence,AA,DNAchange,strain,transcript_name,wbgene,gene_name,grantham_score,blosum_score,percent_protein" > $output_dir/CSQ_${1}_WBGeneID_GRANTHAM_BLOSUM_PP_final.csv
# else 
...
# while IFS=$'\t' read -r chrom pos ref alt consequence AA DNAchange strain transcript_name wbgene locus grantham_score blosum_score; do  ##will need to change
...
#     echo "$chrom,$pos,$ref,$alt,$consequence,$AA,$DNAchange,$strain,$transcript_name,$wbgene,$locus,$grantham_score,$blosum_score,$pp" >> $output_dir/CSQ_${1}_WBGeneID_GRANTHAM_BLOSUM_PP_final.csv
...
#     echo "chrom,pos,ref,alt,consequence,impact,AA,strain,transcript_name,wbgene,gene_name,grantham_score,blosum_score,percent_protein" > $output_dir/VEP_${1}_WBGeneID_GRANTHAM_BLOSUM_PP_final.csv
# else 
...
# # Populate the processed set from existing output
# tail -n +2 $output_dir/VEP_${1}_WBGeneID_GRANTHAM_BLOSUM_PP_final.csv | awk -F',' '{print $2"_"$9}' | while read key; do ##will need to change
#     processed["$key"]=1
# done

# while IFS=$'\t' read -r chrom pos ref alt consequence impact AA strain transcript_name wbgene locus grantham_score blosum_score; do  ##will need to change
...
#     echo "$chrom,$pos,$ref,$alt,$consequence,$impact,$AA,$strain,$transcript_name,$wbgene,$locus,$grantham_score,$blosum_score,$pp" >> $output_dir/VEP_${1}_WBGeneID_GRANTHAM_BLOSUM_PP_final.csv
...
#     echo "chrom,pos,ref,alt,consequence,impact,AA,strain,transcript_name,wbgene,gene_name,grantham_score,blosum_score,percent_protein" > $output_dir/ANNOVAR_${1}_WBGeneID_GRANTHAM_BLOSUM_PP_final.csv
# else 
...
# tail -n +2 $output_dir/ANNOVAR_${1}_WBGeneID_GRANTHAM_BLOSUM_PP_final.csv | awk -F',' '{print $2"_"$9}' | while read key; do ## will need to change
#     processed["$key"]=1
# done
...
#     echo "$chrom,$pos,$ref,$alt,$consequence,$impact,$AA,$strain,$transcript_name,$wbgene,$locus,$grantham_score,$blosum_score,$pp" >> $output_dir/ANNOVAR_${1}_WBGeneID_GRANTHAM_BLOSUM_PP_final.csv
...
# while IFS=$'\t' read -r chrom pos ref alt consequence AA DNAchange strain divergent transcript_name wbgene locus grantham_score blosum_score; do  ##will need to change
...
# while IFS=$'\t' read -r chrom pos ref alt consequence impact AA strain divergent transcript_name wbgene locus grantham_score blosum_score; do  ##will need to change
...
# bcftools view -H WI.20250331.hard-filter.isotype.biallelic.NoMt.HDR.vcf.gz | wc -l # elegans
#  
