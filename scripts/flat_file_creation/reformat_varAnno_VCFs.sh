...
if [[ $1 == "c_elegans" ]]; then
    ...
    VEP_annotated_vcf="/vast/eande106/projects/Lance/THESIS_WORK/variant_annotation/processed_data/VEP/c_briggsae/containerRun/WI.20250626.hard-filter.isotype.biallelic.NoMt.HDR.VEP.vcf.gz"
    CSQ_annotated_vcf="/vast/eande106/projects/Lance/THESIS_WORK/variant_annotation/processed_data/CSQ/c_briggsae/containerRun/WI.20250626.hard-filter.isotype.biallelic.NoMt.HDR.bcsq.vcf.gz"
    SnpEff_annotated_vcf="/vast/eande106/projects/Lance/THESIS_WORK/variant_annotation/processed_data/SnpEff/c_briggsae/containerRun/WI.20250626.hard-filter.isotype.biallelic.onlyMt.ff.vcf.gz"
    SnpEff_preAnnoVCF="/vast/eande106/projects/Lance/THESIS_WORK/variant_annotation/processed_data/flat_file_creation/c_briggsae/WI.20250626.hard-filter.isotype.biallelic.onlyMt.vcf.gz"
...
### TEST TO COMPARE CHROM, POS, ALT, REF, AND GENOTYPE MATRIX FOR EVERY ANNOTATED VCF PRIOR TO TSV CREATION
# VEPcheck=$(mktemp)
# CSQcheck=$(mktemp)
# ANVcheck=$(mktemp)
