...
#SBATCH --output=/vast/eande106/projects/Lance/THESIS_WORK/variant_annotation/processed_data/VEP/c_tropicalis/SLURM_output/0513_run.oe  # Output log
#SBATCH --error=/vast/eande106/projects/Lance/THESIS_WORK/variant_annotation/processed_data/VEP/c_tropicalis/SLURM_output/0513_run.rr  # Error log
...
if [[ $1 == "c_elegans" ]]; then
    ...
    vcf="WI.20250331.hard-filter.isotype.biallelic.NoMt.vcf.gz"
else 
